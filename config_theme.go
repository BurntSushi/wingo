...
func loadFullOption(k wini.Key) {
	...
	case "a_font_color":
		setInt(k, &THEME.full.aFontColor)
	case "i_font_color":
		setInt(k, &THEME.full.iFontColor)
	case "title_size":
	...
	case "a_close_color":
		setInt(k, &THEME.full.aCloseColor)
	case "i_close_color":
		setInt(k, &THEME.full.iCloseColor)
	case "maximize":
		setImage(k, &THEME.full.aMaximizeButton)
		setImage(k, &THEME.full.iMaximizeButton)
	case "a_maximize_color":
		setInt(k, &THEME.full.aMaximizeColor)
	case "i_maximize_color":
		setInt(k, &THEME.full.iMaximizeColor)
	case "minimize":
		setImage(k, &THEME.full.aMinimizeButton)
		setImage(k, &THEME.full.iMinimizeButton)
	case "a_minimize_color":
		setInt(k, &THEME.full.aMinimizeColor)
	case "i_minimize_color":
		setInt(k, &THEME.full.iMinimizeColor)
	case "border_size":
		setInt(k, &THEME.full.borderSize)
	case "a_border_color":
		setInt(k, &THEME.full.aBorderColor)
	case "i_border_color":
		setInt(k, &THEME.full.iBorderColor)
	}
}
...
func loadBorderOption(k wini.Key) {
	...
	case "a_thin_color":
		setInt(k, &THEME.borders.aThinColor)
	case "i_thin_color":
		setInt(k, &THEME.borders.iThinColor)
	case "a_border_color":
...
func loadSlimOption(k wini.Key) {
	...
	case "a_border_color":
		setInt(k, &THEME.slim.aBorderColor)
	case "i_border_color":
		setInt(k, &THEME.slim.iBorderColor)
	}
}
...
func loadPromptOption(k wini.Key) {
	switch k.Name() {
	case "bg_color":
		setInt(k, &THEME.prompt.bgColor)
	case "border_color":
		setInt(k, &THEME.prompt.borderColor)
	case "border_size":
	...
	case "font_color":
		setInt(k, &THEME.prompt.fontColor)
